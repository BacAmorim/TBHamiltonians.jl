...
"""
function TBHamiltonian(A::AbstractVector...; hoppingtype=Float64)
...
## Add orbitals
"""
    add_orbital!(sys::TBHamiltonian, pos::AbstractVector, lm=(0, 0))

Given a label, position (pos), angular momentum (l, m) adds an Orbital(pos, (l, m)) to the tight-binding TBHamiltonian
"""
function add_orbital!(sys::TBHamiltonian, pos::AbstractVector, lm=(0, 0))
...
"""
    add_orbital!(sys::TBHamiltonian, pos::AbstractVector, wf::Symbol)

Given a label, position (pos), atomic wavefunction type adds an Orbital(pos, wf) to the tight-binding TBHamiltonian
"""
function add_orbital!(sys::TBHamiltonian, pos::AbstractVector, wf::Symbol)
...
## Add hopping
"""
    add_hopping!(sys::TBHamiltonian, from::Int, to::Int, dir::AbstractVector{Int}, val)
...
"""
function add_hopping!(sys::TBHamiltonian, from::Int, to::Int, dir::AbstractVector{Int}, val)
